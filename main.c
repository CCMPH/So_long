...
/*   Updated: 2022/07/18 14:37:37 by chartema      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	remove_collectable(t_game *game)
{
	...
	printf("Wat is tot_collected: %d\n", game->data->tot_collectables);
	printf("Wat is carrots: %d\n", game->data->nr_carrot);
	index = game->data->tot_collectables - game->data->nr_carrot;
...
void	set_movement(t_game *game, t_direction direction)
{
	...
	{
		game->data->nr_carrot++;
		game->data->map[game->data->map_player_y][game->data->map_player_x] = '0';
